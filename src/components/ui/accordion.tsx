...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header>
    <AccordionPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex w-full items-center justify-between rounded-t-lg bg-gray-50 px-4 py-3 text-sm font-medium transition-all hover:bg-gray-100 [&[data-state=open]>svg]:rotate-180",
        className
      )}
      {...props}
    >

...
function FormContent() {
  ...
  const loadInitialData = useCallback(async () => {
    ...
    try {
      ...
      // If editing, fetch the specific lease
      if (editingLeaseId) {
        console.log(`Fetching lease data for editing: ${editingLeaseId}`);
        // NOTE: getLeaseById needs to be implemented in firestoreUtils
        const leaseToEdit = await getLeaseById(landlordId, editingLeaseId); 
        
        if (leaseToEdit) {
          console.log("Lease data found for editing:", leaseToEdit);
          ...
          setIsActive(leaseToEdit.isActive);
           ...
           console.error(`Lease with ID ${editingLeaseId} not found.`);
           setFormError(`Lease with ID ${editingLeaseId} not found. Cannot edit.`);
  ...
  const displayUnitNumberForTitle = editingLeaseId ? (unitNumber || getUnitNumber(unitId)) : '';
      ...
      <div className="md:ml-64 p-4">
        ...
        <main className="max-w-4xl mx-auto">
          <Card ref={formRef} className="mb-8">
            <CardHeader>
              <CardTitle>
                {editingLeaseId ? `Edit Lease for Unit ${displayUnitNumberForTitle}` : 'Add New Lease'}
              </CardTitle>
            </CardHeader>
            ...
            <CardContent className="px-2 sm:px-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <CardContent className="grid grid-cols-1 gap-4 px-3 sm:px-6">
                    <div className="col-span-1">
                      ...
                      <select
                        ...
                        // Disable if editing, as unit shouldn't change for an existing lease
                ...
                <div className="flex justify-end space-x-3 pt-4">
                  <Button
                    type="button"
                    onClick={() => router.push('/dashboard/tenants')} // Navigate back to list
                    variant="outline"
                    style={{
